...
<div class="row">
  <div class="section">
    ...
    <div class="col m11 s12">
      <div class="row">
        <h3 class="flow-text"><i class="material-icons">mode_edit</i> Editar Documento
          <a href="/documents" class="btn waves-effect waves-light right tooltipped" data-position="left" data-delay="50" data-tooltip="Ir Atrás"><i class="material-icons">arrow_back</i> Volver</a>
        </h3>
        ...
        <div class="col m8 s12">
          ...
          <div class="card">
            <div class="card-content">
              ...
              <div class="input-field">
                <p class="center">
                  {{ Form::submit('Guardar Cambios',['class' => 'btn-large waves-effect waves-light']) }}
                </p>
              </div>
            </div>
          </div>
