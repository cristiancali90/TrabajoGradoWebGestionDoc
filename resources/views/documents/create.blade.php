...
<div class="row">
  <div class="section">
    ...
    <div class="col m11 s12">
      <div class="row">
        <h3 class="flow-text"><i class="material-icons">folder</i> Cargar Documento
          <a href="/documents/create" class="btn waves-effect waves-light right tooltipped" data-position="left" data-delay="50" data-tooltip="Cargar Un Nuevo Documento"><i class="material-icons">file_upload</i> Nuevo Documento</a>
        </h3>
          ...
          <div class="card hoverable">
            <div class="card-content">
              ...
              <div class="input-field">
                ...
                <label for="isExpire">No Expira</label>
              </div>
              <br>
              <div class="input-field">
                ...
                <label for="expirePicker">Documento Expira En</label>
              </div>
              <br>
              <div class="input-field">
                <i class="material-icons prefix">class</i>
                {{ Form::select('category_id[]',$categories,null,['multiple' => 'multiple', 'id' => 'category', 'placeholder' => 'Seleccionar Categoria']) }}
              ...
              <div class="file-field input-field">
                <div class="btn white">
                  <span class="black-text">Cargar Archivo (Max: 50MB)</span>
                  {{ Form::file('file') }}
                  @if ($errors->has('file'))
              ...
              <div class="input-field">
                <p class="center">
                  {{ Form::submit('Guardar',['class' => 'btn-large waves-effect waves-light']) }}
                </p>
              </div>
            </div>
          </div>
