...
<div class="row">
  <div class="section">
    ...
    <div class="col m11 s12">
      <div class="row">
        <h3 class="flow-text"><i class="material-icons">info</i> Información del Documento</h3>
        <div class="btn-icons">
          {!! Form::open() !!}
          ...
          @can('shared')
          <a href="#" class="btn-circle purple waves-effect waves-light data-share tooltipped" data-position="top" data-delay="50" data-tooltip="Compartir" data-form="documents-{{ $doc->id }}"><i class="material-icons">share</i></a>
          @endcan
          {!! Form::close() !!}
          <!-- DELETE using link -->
          ...
          @can('delete')
          <a href="#" class="btn-circle red waves-effect waves-light data-delete tooltipped" data-position="right" data-delay="50" data-tooltip="Borrar" data-form="documents-{{ $doc->id }}"><i class="material-icons">delete</i></a>
          @endcan
          {!! Form::close() !!}
        </div>
      </div>
        ...
        <div class="card horizontal hoverable">
          ...
          <div class="card-stacked">
            <div class="card-content">
              @if($doc->isExpire == 2)
                <h5 class="red-text">
                  <i class="material-icons">error_outline</i> Este Documento Ha Expirado!
                </h5>
                <p class="red-text">Considere la posibilidad de eliminar o restaurar este documento.</p>
              @endif
              <ul class="collapsible" data-collapsible="accordion">
                <li>
                  <div class="collapsible-header active"><i class="material-icons">folder</i>Nombre del Documento</div>
                ...
                <li>
                  <div class="collapsible-header"><i class="material-icons">account_circle</i>Propietario</div>
                  <div class="collapsible-body"><span class="teal-text">{{ $doc->user['name'] }}</span></div>
                </li>
                <li>
                  <div class="collapsible-header"><i class="material-icons">group</i>Área</div>
                  <div class="collapsible-body"><span class="teal-text">{{ $doc->user->department['dptName'] }}</span></div>
                </li>
                <li>
                  <div class="collapsible-header"><i class="material-icons">class</i>Categoría</div>
                ...
                <li>
                  <div class="collapsible-header"><i class="material-icons">date_range</i>Expira En</div>
                  <div class="collapsible-body">
                    <span class="teal-text">
                      @if($doc->isExpire)
                        {{ $doc->expires_at }}
                ...
                <li>
                  <div class="collapsible-header"><i class="material-icons">date_range</i>Fecha de Carga</div>
                  <div class="collapsible-body"><span class="teal-text">{{ $doc->created_at->toDayDateTimeString() }}</span></div>
                </li>
                <li>
                  <div class="collapsible-header"><i class="material-icons">date_range</i>Fecha de Actualización</div>
            ...
            <div class="card-action">
              <a href="/documents" class="teal-text">Atrás</a>
            </div>
          </div>
        </div>
      </div>
