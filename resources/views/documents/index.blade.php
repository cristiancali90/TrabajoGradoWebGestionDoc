  ...
  <div class="section">
    ...
    <div class="col m11 s12">
      <div class="row">
        ...
        <button class="btn red waves-effect waves-light right tooltipped delete_all" data-url="{{ url('documentsDeleteMulti') }}" data-position="left" data-delay="50" data-tooltip="Eliminar Documentos Seleccionados"><i class="material-icons">delete</i></button>
        @can('upload')
          <a href="/documents/create" class="btn waves-effect waves-light right tooltipped" data-position="left" data-delay="50" data-tooltip="Cargar Nuevo Documento"><i class="material-icons">file_upload</i></a>
        @endcan
        </h3>
          ...
          <div id="folderView">
            <div class="row">
              <form action="/sort" method="post" id="sort-form">
                ...
                <div class="input-field col m2 s12">
                  <select name="filetype" id="sort">
                    ...
                    <option value="image/jpeg" @if($filetype === 'image/jpeg') selected @endif>Imágen</option>
                    ...
                    <option value="application/vnd.openxmlformats-officedocument.wordprocessingml.document">Documentos de Word</option>
                    <option value="">Otros</option>
                  </select>
                  <label>Ordenar por Tipo de Archivo</label>
                </div>
              </form>
              <form action="/search" method="post" id="search-form">
                ...
                <div class="input-field col m4 s12 right">
                  ...
                  <input type="text" name="search" id="search" placeholder="Buscar Aquí...">
            ...
            <div class="row">
              @if(count($docs) > 0)
                ...
                @endforeach
              @else
                <h5 class="teal-text">No hay documentos cargados</h5>
              @endif
            </div>
          </div>
          <!-- TABLE View -->
                  ...
                  @if(count($docs) > 0)
                    ...
                    <tr id="tr_{{$doc->id}}">
                      ...
                      <td>
                        ...
                        @can('shared')
                        <a href="" class="data-share tooltipped" data-position="left" data-delay="50" data-tooltip="Compartir" data-form="documents-{{ $doc->id }}"><i class="material-icons">share</i></a>
                        @endcan
                        {!! Form::close() !!}
                        {!! Form::open() !!}
                        @can('edit')
  ...
  <ul class="context-menu_items">
    ...
    <li class="context-menu_item">
      <a href="#" class="context-menu_link" data-action="Share">
        <i class="material-icons">share</i><p>Compartir</p>
      </a>
    </li>
    <li class="context-menu_item">
    ...
    <li class="context-menu_item">
      <a href="#" class="context-menu_link" data-action="Delete">
        <i class="material-icons">delete</i><p>Eliminar</p>
      </a>
    </li>
  </ul>
</div>
