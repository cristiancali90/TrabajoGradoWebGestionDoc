  ...
  <div class="section">
    ...
    <div class="col m11 s12">
      <div class="row">
        ...
        <a href="#" class="btn red waves-effect waves-light right tooltipped" data-position="left" data-delay="50" data-tooltip="Eliminar Documentos Seleccionados"><i class="material-icons">delete</i></a>
        @can('upload')
      ...
      <div class="card z-depth-2">
        <div class="card-content">
		 ...
		 task" data-id="{{ $r->id }}">
            ...
            @endforeach
          @else
            <h5 class="teal-text">No se encontraron resultados :(</h5>
          @endif
          </div>
        </div>
      </div>
