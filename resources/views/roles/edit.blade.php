...
<div class="row">
	<div class="section">
		...
		<div class="col m11 s12">
			<div class="row">
				<h3 class="flow-text"><i class="material-icons">mode_edit</i> Roles + Permisos</h3>
				...
				<div class="col m7 offset-m2">
					...
					<div class="card z-depth-2 hoverable">
						<div class="card-content">
							<h5 class="indigo-text">Asignación De Permisos Al Rol</h5>
							<br>
							...
							<br>
							<div class="input-field">
							  	<h6 class="teal-text">Permisos Asignables</h6>
							  	<br>	
						  	...
						  	<br>
							<div class="input-field">
								<p class="center">{{ Form::submit('Asignar', ['class' => 'btn waves-effect waves-light']) }}</p>
							</div>
						</div>
					</div>
					{!! Form::close() !!}
