          ...
          <div class="col m4 s6">
            <div class="card hoverable indigo lighten-1 white-text">
              <div class="card-content">
                ...
                <h4 class="center-align flow-text">Documentos<span class="new badge white-text">336</span></h4>
              </div>
            </div>
          </div>
        </a>
          ...
          <div class="col m4 s6">
            <div class="card hoverable indigo lighten-1 white-text">
              <div class="card-content">
                ...
                <h4 class="center-align flow-text">Áreas</h4>
              </div>
            </div>
          </div>
        </a>
          ...
          <div class="col m4 s6">
            <div class="card hoverable indigo lighten-1 white-text">
              <div class="card-content">
                ...
                <h4 class="center-align flow-text">Roles &amp; Permisos</h4>
              </div>
            </div>
          </div>
        </a>
          ...
          <div class="col m4 s6">
            <div class="card hoverable indigo lighten-1 white-text">
              <div class="card-content">
                ...
                <h4 class="center-align flow-text">Categorías</h4>
              </div>
            </div>
          </div>
        </a>
