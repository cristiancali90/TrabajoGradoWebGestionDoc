...
<div class="row">
  <div class="section">
    ...
    <div class="col m11 s12">
      <div class="row">
        <h3 class="flow-text"><i class="material-icons">class</i> Categorías
      ...
      <div class="card z-depth-2">
        ...
        <button class="btn red waves-effect waves-light delete_all" data-url="{{ url('categoriesDeleteMulti') }}">Borrar Todas Las Seleccionadas</button>
          <table class="responsive-table bordered centered highlight">
            ...
            @else
              <tr>
                <td colspan="3"><h5 class="teal-text">No hay categorías creadas</h5></td>
              </tr>
            @endif
            </tbody>
          </table>
