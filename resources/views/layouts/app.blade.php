  ...
  <main>
    <div id="app">
      ...
      <div class="fixed-action-btn">
        <a href="#" class="btn btn-floating btn-large tooltipped" data-position="left" data-delay="50" data-tooltip="Acceso Rápido">
          <i class="large material-icons">explore</i>
        </a>
        <ul>
          <li>
            <a href="/documents/create" class="btn-floating btn-large tooltipped" data-position="left" data-delay="50" data-tooltip="Cargar Documento"><i class="large material-icons">file_upload</i></a>
          </li>
