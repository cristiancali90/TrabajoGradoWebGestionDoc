...
<script type="text/javascript">
  ...
  $(function () {
      $('.data-delete').on('click', function (e) {
          if (!confirm('¿Desea de eliminar el documento?')) return;
          e.preventDefault();
  ...
  $(function () {
      $('.data-share').on('click', function (e) {
          if (!confirm('¿Desea compartir el documento?')) return;
          e.preventDefault();
    ...
    $(document).ready(function () {
        ...
        $('.delete_all').on('click', function(e) {
            ...
            if(allVals.length <=0)
            {
                ...
                var check = confirm("¿Seguro de querer eliminar?");
                if(check == true){
