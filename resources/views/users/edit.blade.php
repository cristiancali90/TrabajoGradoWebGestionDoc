...
<div class="row">
  <div class="section">
    ...
    <div class="col m11 s12">
      <div class="row">
        <h3 class="flow-text"><i class="material-icons">mode_edit</i> Editar Usuario</h3>
            ...
            <div class="card-content">
              <div class="row">
                <div class="input-field">
                  ...
                  <label for="name" class="blue-text">Nombre Actual</label>
                </div>
              </div>
              <div class="row">
                <div class="input-field">
                  ...
                  <label for="email" class="blue-text">Correo Electrónico Actual</label>
                </div>
              </div>
              <div class="row">
                <div class="input-field">
                  ...
                  <label for="department_id" class="blue-text">Área Actual</label>
                </div>
              </div>
              <div class="row">
                <div class="input-field">
                  ...
                  <label for="role" class="blue-text">Rol Actual</label>
                </div>
              </div>
              <div class="row">
                <!-- Switch -->
                <div class="switch left">
                  <h5>Estado de la Cuenta de Usuario</h5>
                  <label>
                    @if($user->status)
                      Disable
                ...
                <div class="right">
                  <p><a href="#modal1" class="modal-trigger">¿ Desea Cambiar Contraseña ?</a></p>
                </div>
              </div>
              <br>
              <div class="row">
